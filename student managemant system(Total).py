...
class Student:
    def __init__(self,root):  #constructor initialize
        self.root=root
        self.root.geometry('3840x2160+0+0') #for window display
        ...
        #1st image
        img=Image.open(r"C:\Users\HP\Desktop\STUDENT MANAGEMENT SYSTEM PRACTICE\college_images\7th.jpg")
        img=img.resize((540,160),Image.LANCZOS) #convert high level image to low level image
        ...
        #2nd image
        img_2=Image.open(r"C:\Users\HP\Desktop\STUDENT MANAGEMENT SYSTEM PRACTICE\college_images\3rd.jpg")
        img_2=img_2.resize((540,160),Image.LANCZOS) #convert high level image to low level image
        ...
        #3rd image
        img_3=Image.open(r"C:\Users\HP\Desktop\STUDENT MANAGEMENT SYSTEM PRACTICE\college_images\9th.jpg")
        img_3=img_3.resize((540,160),Image.LANCZOS) #convert high level image to low level image
        ...
        #background image
        img_4=Image.open(r"C:\Users\HP\Desktop\STUDENT MANAGEMENT SYSTEM PRACTICE\college_images\university.jpg")
        img_4=img_4.resize((2080,790),Image.LANCZOS) #convert high level image to low level image
        ...
        img_5=Image.open(r"C:\Users\HP\Desktop\STUDENT MANAGEMENT SYSTEM PRACTICE\college_images\11th.jpg")
        img_5=img_5.resize((600,125),Image.LANCZOS) #convert high level image to low level image
        ...
        img_6=Image.open(r"C:\Users\HP\Desktop\STUDENT MANAGEMENT SYSTEM PRACTICE\college_images\janko-ferlic-sfL_QOnmy00-unsplash.jpg")
        img_6=img_6.resize((840,150),Image.LANCZOS) #convert high level image to low level image
    ...
    def add_data(self):
        if self.var_dep.get()=='' or self.var_name.get()=='' or self.var_id.get()=='':
            ...
            try:
                conn=mysql.connector.connect(host='localhost',username='root',password='Babu123!',database='codewithkiran')
    ...
    def update_data(self):
            ...
            try:
                ...
                if update>0:
                   ...
                   my_cursur.execute("update student set dep=%s,couse=%s,year=%s,semester=%s,name=%s,division=%s,roll=%s,gender=%s,DoB=%s,Email=%s,phone=%s,address=%s,teacher=%s where student_id=%s",(    
                                                                                                                                                              self.var_dep.get(),
                                                                                                                                                              self.var_course.get(),
                                                                                                                                                              self.var_year.get(),
                                                                                                                                                              self.var_sem.get(),
